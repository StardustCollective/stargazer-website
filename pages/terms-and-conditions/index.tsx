    ...
    <Layout>
      <div className={styles.pageWrapper}>
        ...
        <div className={styles.body}>
          ...
          <p className={styles.TYPO_XSMALL}>Last updated: February 11, 2021</p>
          <p className={styles.TYPO_XSMALL}>
            Please read these terms and conditions carefully before using Our
            Service.
          </p>
          <p className={styles.TYPO_MEDIUM}>Interpretation and Definitions</p>
          ...
          <p className={styles.TYPO_SMALL}>
            ...
            <span className={styles.TYPO_XSMALL}>
              ...
              You on any electronic device, named Stargazer Wallet
            </span>
          </p>
          <p className={styles.TYPO_SMALL}>
            APPLICATION STORE{" "}
          ...
          <p className={styles.TYPO_SMALL}>
            ...
            <span className={styles.TYPO_XSMALL}>
              ...
              Agreement) refers to Stardust Collective, an international
              decentralized work group.
            </span>
          </p>
          <p className={styles.TYPO_SMALL}>
            DEVICE{" "}
          ...
          <p className={styles.TYPO_MEDIUM}>Acknowledgment</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>User Wallet</p>
          <p className={styles.TYPO_XSMALL}>
            You are responsible for safeguarding the password and seed phrase
          ...
          <p className={styles.TYPO_XSMALL}>
            You agree not to disclose Your password or seed phrase to any third
            party. You must notify Us immediately upon becoming aware of any
            breach of security or unauthorized use of Your account.
          </p>
          <p className={styles.TYPO_MEDIUM}>Intellectual Property</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Links to Other Websites</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Termination</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Limitation of Liability</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>
          ...
          <p className={styles.TYPO_MEDIUM}>Governing Law</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Disputes Resolution</p>
          <p className={styles.TYPO_XSMALL}>
            If You have any concern or dispute about the Service, You agree to
            first try to resolve the dispute informally by contacting the
            Company.
          </p>
          <p className={styles.TYPO_MEDIUM}>For European Union (EU) Users</p>
          <p className={styles.TYPO_XSMALL}>
            If You are a European Union consumer, you will benefit from any
            mandatory provisions of the law of the country in which you are
            resident in.
          </p>
          <p className={styles.TYPO_MEDIUM}>United States Legal Compliance</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Severability and Waiver</p>
          <p className={styles.TYPO_SMALL}>
            Severability
            <br />
            <span className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Translation Interpretation</p>
          <p className={styles.TYPO_XSMALL}>
          ...
          <p className={styles.TYPO_MEDIUM}>Contact Us</p>
          <p className={styles.TYPO_XSMALL}>
